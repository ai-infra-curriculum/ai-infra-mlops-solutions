...
Reference for [learning ex-05](https://github.com/ai-infra-curriculum/ai-infra-mlops-learning/blob/main/lessons/mod-009-security/exercises/exercise-05-complete-mlops-security-framework.md).
...
Companion projects: [project-4-governance](https://github.com/ai-infra-curriculum/ai-infra-mlops-learning/tree/main/projects/project-04-governance) (audit trail + GDPR) + [project-5-llmops](https://github.com/ai-infra-curriculum/ai-infra-mlops-learning/tree/main/projects/project-05-llmops) (guardrails + rate-limit + cost-meter).
