...
Reference for [learning ex-02](https://github.com/ai-infra-curriculum/ai-infra-mlops-learning/blob/main/lessons/mod-002-experiment-tracking/exercises/exercise-02-model-registry-lifecycle-management.md).
