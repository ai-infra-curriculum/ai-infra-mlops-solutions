...
Reference for [learning ex-04](https://github.com/ai-infra-curriculum/ai-infra-mlops-learning/blob/main/lessons/03-model-monitoring/exercises/exercise-04-alert-configuration-and-response.md).
