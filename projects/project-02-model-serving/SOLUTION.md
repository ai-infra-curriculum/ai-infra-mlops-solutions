...
> `ai-infra-mlops-learning/projects/project-02-model-serving`. This
...
2. Try to build it from the
   [REQUIREMENTS.md](https://github.com/ai-infra-curriculum/ai-infra-mlops-learning/blob/main/projects/project-02-model-serving/REQUIREMENTS.md)
