...
Reference for [learning project 2](https://github.com/ai-infra-curriculum/ai-infra-mlops-learning/tree/main/projects/project-2-model-serving).
...
2. Try to build it from scratch using [REQUIREMENTS.md](https://github.com/ai-infra-curriculum/ai-infra-mlops-learning/blob/main/projects/project-2-model-serving/REQUIREMENTS.md).
