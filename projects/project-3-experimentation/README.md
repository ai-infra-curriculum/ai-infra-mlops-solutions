...
Reference for [learning project 3](https://github.com/ai-infra-curriculum/ai-infra-mlops-learning/tree/main/projects/project-3-experimentation).
...
- [mlops-solutions modules/05-experimentation](../../modules/05-experimentation/) — the per-exercise solutions in this repo

## Sample composition

The pieces shown in modules/05-experimentation come together in the learning
project as:
