...
> `ai-infra-mlops-learning/projects/project-3-experimentation`. This
...
1. Read the [learning project README](https://github.com/ai-infra-curriculum/ai-infra-mlops-learning/tree/main/projects/project-3-experimentation).
...
| Per-exercise platform components | `mlops-solutions/modules/05-experimentation/` |
| Per-prediction audit log | `mlops-learning/projects/project-4-governance/src/audit/log.py` |
